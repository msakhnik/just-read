import os.path
# Django settings for justread project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'django_justread_db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '-2frm*e!y!^f@%!&amp;s#4$4-it_$)zy-r-y_h*l4$ah40a9dyj1)'
...
ROOT_URLCONF = 'justread.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'justread.wsgi.application'
